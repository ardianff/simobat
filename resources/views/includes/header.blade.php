    ...
    <div class="container-fluid">
        ...
        <ul class="header-nav ms-3">
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#"
                    ...
                    <div class="avatar avatar-md"><img class="avatar-img" src="{{ url('assets/img/avatars/8.jpg') }}"
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    {{-- <svg class="icon me-2">
                        ...
                        href="#">
                        <svg class="icon me-2">
                            <use xlink:href="{{ url('vendors/@coreui/icons/svg/free.svg#cil-envelope-open') }}">
                            </use>
